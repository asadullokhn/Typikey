...
- Home is the generative board: all of Core — pronouns (I, you, he, she, it), the auxiliaries `be`, `do`, `have`, and the verbs that combine with everything — then whichever conversation openers still fit. That is where the freedom is: a stored phrase says one thing, while "he" + "be" + the tense key says "he is", "he was", "he will be". Fixed phrases stay one tap away on Chat
